            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                ...
                <Button asChild className="w-full">
                  <a href="https://github.com/nanainternational/nana-renewal/releases/latest/download/nana-1688-extractor.zip" target="_blank" rel="noopener noreferrer">
                    확장프로그램 ZIP 다운로드
                  </a>
                </Button>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                ...
                <ol className="text-sm text-muted-foreground list-decimal pl-5 space-y-1">
                  ...
                  <li>“OK”가 뜨면 우리 사이트로 돌아와 <b>중국사입</b> 페이지에서 <b>가져오기</b>를 누릅니다.</li>
                </ol>
                <div className="text-xs text-muted-foreground">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-2">
              ...
              <ul className="text-sm text-muted-foreground list-disc pl-5 space-y-1">
                <li><b>가져오기에서 404</b>: 서버에 GET 라우트가 없으면 발생합니다. (이미 수정됨)</li>
                <li><b>이미지 안 보임</b>: alicdn 핫링크/권한 문제로 프록시로 우회합니다.</li>
                <li><b>데이터를 비우고 싶음</b>: 중국사입 페이지의 <b>초기화</b> 버튼을 누르세요.</li>
              </ul>
            </div>
          </div>
        </Card>

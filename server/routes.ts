         ...
         left join lateral (
            select json_agg(
                    json_build_object(
                      ...
                      'source_url', coalesce(nullif(oi.raw_item->>'detail_url', ''), nullif(oi.raw_item->>'detailUrl', ''), nullif(oi.raw_item->>'productUrl', ''), nullif(o.source_payload->>'url', ''), oi.product_url),
